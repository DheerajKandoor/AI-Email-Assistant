...
public class EmailGeneratorService {
    ...
    public String generateEmailReply(EmailRequest emailRequest) {
        ...
        // TODO: Send Request using WebClient
...
//        return requestBody; // for now returning JSON body to test
    }
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a professional Email reply (without a subject and dont provide options to choose) for the following email : ");
